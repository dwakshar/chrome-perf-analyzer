...
```
  ...
  ╚██████╗██║  ██║██║  ██║╚██████╔╝██║ ╚═╝ ██║███████╗
   ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝
              ...
              P E R F   A N A L Y Z E R
    ─────────────────────────────────────────────
    Real-time performance diagnostics for Chrome DevTools
```
...
Performance problems hide behind numbers. You open the Network tab and see 300 requests. You open Coverage and see 73% unused JavaScript. You open Performance and see a 900ms long task. But you still don't know *what to fix first* or *how much it would matter*.
...
*If this saved you debugging time, a ⭐ means a lot.*
